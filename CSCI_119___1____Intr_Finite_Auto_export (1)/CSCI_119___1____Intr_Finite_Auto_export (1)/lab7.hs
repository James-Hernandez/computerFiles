...
delta_star :: FSM int-> Int -> [Char] -> Int
...
proper One = False
proper (Let' c) = True
proper (Union' (x:xs)) = proper x && proper (Union' xs)
proper (Cat' (x:xs)) = proper x || proper (Cat' xs)
proper (Star' r) = proper r
...
test_fromRE' = fromRE' test_conv 
--Cat (Star (Let 'a')) (Cat (Let 'b') (Star (Union (Let 'a') (Cat (Let 'b') (Cat (Star (Let 'a')) (Let 'b'))))))



test_fromRE = fromRE $ fromRE' test_conv 
--Cat' [Star' (Let' 'a'),Cat' [Let' 'b',Star' (Union' [Let' 'a',Cat' [Let' 'b',Cat' [Star' (Let' 'a'),Let' 'b']]])]]

listR' = map toRE' ["ab+","aa.","a*"]
--[Union' [Let' 'a',Let' 'b'],Cat' [Let' 'a',Let' 'a'],Star' (Let' 'a')]
listR'' = [map toRE' ["ab+","aa."]]
--[[Union' [Let' 'a',Let' 'b'],Cat' [Let' 'a',Let' 'a']]]
listR1' = map toRE' ["a","ab.","b*"]
--[Let' 'a',Cat' [Let' 'a',Let' 'b'],Star' (Let' 'b')]
test_solve = solve listR'' listR'
--[Union' [Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'a'],Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'b']]]
test_solve1 = solve listR'' listR1'
--[Cat' [Star' (Union' [Let' 'a',Let' 'b']),Let' 'a']]
test_solve2 = solve listR'' [test_conv]
--[Cat' [Star' (Union' [Let' 'a',Let' 'b']),Star' (Let' 'a'),Let' 'b',Star' (Union' [Let' 'a',Cat' [Let' 'b',Star' (Let' 'a'),Let' 'b']])]]
test_conv = conv odd_bs
--Cat' [Star' (Let' 'a'),Let' 'b',Star' (Union' [Let' 'a',Cat' [Let' 'b',Star' (Let' 'a'),Let' 'b']])]
test_SPLE = toSPLE odd_bs
